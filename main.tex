...
\textbf{Catch}
\begin{equation}
    E[\text{Catch}\ M] \Downarrow \text{Where M is strict. See Section \ref{section: catch}}
\end{equation}
...
introduce bounded SPCF somewherre -> maybe in lit review?
